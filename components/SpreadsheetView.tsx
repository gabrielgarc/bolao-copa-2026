      ...
      <tr key={match.id} className={`border-b border-gray-200 hover:bg-blue-50 transition-colors ${isLocked ? 'bg-gray-50' : ''} ${isFinal ? 'bg-gradient-to-r from-yellow-50 to-amber-100 hover:from-yellow-100 hover:to-amber-200' : ''}`}>
        ...
        <td className="p-0.5 md:p-2 border-r border-gray-200 text-right overflow-hidden">
          <div className="flex items-center justify-end gap-0.5 md:gap-3">
            <span className={`uppercase font-bold text-[6px] tracking-tighter md:tracking-normal leading-[1.3] md:text-[15px] md:leading-tight min-w-0 truncate md:whitespace-normal md:break-words pt-0.5 ${isLocked ? 'text-gray-400' : 'text-black'}`}>
        ...
        <td className="p-0.5 md:p-2 text-left overflow-hidden">
          <div className="flex items-center gap-0.5 md:gap-3">
            ...
            <span className={`uppercase font-bold text-[6px] tracking-tighter md:tracking-normal leading-[1.3] md:text-[15px] md:leading-tight min-w-0 truncate md:whitespace-normal md:break-words pt-0.5 ${isLocked && !isOfficial ? 'text-gray-400' : 'text-black'}`}>
